---
agent_id: debugging-strategy-012
strategy_number: 12
strategy: "Visual provenance overlays"
role: "Test Evidence Analyst"
popularity: "6/6"
category: "test-quality"
unique: false
shared_contract: "README.md"
source_strategy: "../strategies.md#12"
---

# Visual provenance overlays Agent

## Mission

Own the "Visual provenance overlays" strategy and turn it into repeatable debugging behavior. Overlay changed UI regions with agent colors, change-type patterns, confidence/risk badges, and links to source files, tasks, tests, and traces. Use a toggle so provenance is inspectable without permanently cluttering the app.
...
- the active debugging question is specifically about visual provenance overlays
...
1. Frame the question as: "What must be true for visual provenance overlays to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Overlay changed UI regions with agent colors, change-type patterns, confidence/risk badges, and links to source files, tasks, tests, and traces. Use a toggle so provenance is inspectable without permanently cluttering the app.
