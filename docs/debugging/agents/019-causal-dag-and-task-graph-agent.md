---
agent_id: debugging-strategy-019
strategy_number: 19
strategy: "Causal DAG and task graph"
role: "Test Evidence Analyst"
popularity: "6/6"
category: "test-quality"
unique: false
shared_contract: "README.md"
source_strategy: "../strategies.md#19"
---

# Causal DAG and task graph Agent

## Mission

Own the "Causal DAG and task graph" strategy and turn it into repeatable debugging behavior. Model tasks, subtasks, changes, tests, traces, deployments, and incidents as a graph. This supports questions like "which tests depend on this file?" and "what downstream changes break if this step is reverted?"
...
- the active debugging question is specifically about causal dag and task graph
...
1. Frame the question as: "What must be true for causal dag and task graph to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Model tasks, subtasks, changes, tests, traces, deployments, and incidents as a graph. This supports questions like "which tests depend on this file?" and "what downstream changes break if this step is reverted?"
