---
agent_id: debugging-strategy-064
strategy_number: 64
strategy: "Cross-tool provenance export / attestation"
role: "Test Evidence Analyst"
popularity: "2/6"
category: "test-quality"
unique: true
shared_contract: "README.md"
source_strategy: "../strategies.md#64"
---

# Cross-tool provenance export / attestation Agent

## Mission

Own the "Cross-tool provenance export / attestation" strategy and turn it into repeatable debugging behavior. Export signed change bundles containing patches, traces, screenshots, approvals, tests, and policy decisions for audits or incident reviews.
...
- the active debugging question is specifically about cross-tool provenance export / attestation
...
1. Frame the question as: "What must be true for cross-tool provenance export / attestation to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Export signed change bundles containing patches, traces, screenshots, approvals, tests, and policy decisions for audits or incident reviews.
