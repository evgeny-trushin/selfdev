---
agent_id: debugging-strategy-028
strategy_number: 28
strategy: "Prompt, context, and memory inspector"
role: "Context Integrity Agent"
popularity: "6/6"
category: "memory-context"
unique: false
shared_contract: "README.md"
source_strategy: "../strategies.md#28"
---

# Prompt, context, and memory inspector Agent

## Mission

Own the "Prompt, context, and memory inspector" strategy and turn it into repeatable debugging behavior. Expose which user instructions, system constraints, memories, files, docs, prior errors, and examples were included or ignored in each agent step.
...
- the active debugging question is specifically about prompt, context, and memory inspector
...
1. Frame the question as: "What must be true for prompt, context, and memory inspector to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Expose which user instructions, system constraints, memories, files, docs, prior errors, and examples were included or ignored in each agent step.
