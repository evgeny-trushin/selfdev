---
agent_id: debugging-strategy-071
strategy_number: 71
strategy: "Plugin ecosystem for custom diff types"
role: "Test Evidence Analyst"
popularity: "1/6"
category: "test-quality"
unique: true
shared_contract: "README.md"
source_strategy: "../strategies.md#71"
---

# Plugin ecosystem for custom diff types Agent

## Mission

Own the "Plugin ecosystem for custom diff types" strategy and turn it into repeatable debugging behavior. Allow domain-specific plugins for shader diffs, analytics diffs, policy diffs, schema diffs, visual tests, or specialized compliance checks.
...
- the active debugging question is specifically about plugin ecosystem for custom diff types
...
1. Frame the question as: "What must be true for plugin ecosystem for custom diff types to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Allow domain-specific plugins for shader diffs, analytics diffs, policy diffs, schema diffs, visual tests, or specialized compliance checks.
