---
agent_id: debugging-strategy-030
strategy_number: 30
...
source_strategy: "../strategies.md#30"
---

# Assumption ledger Agent

## Mission

Own the "Assumption ledger" strategy and turn it into repeatable debugging behavior. Require agents to record important assumptions and mark them as validated, contradicted, obsolete, or still unverified. This helps explain why a plausible patch later failed.
...
- the active debugging question is specifically about assumption ledger
...
1. Frame the question as: "What must be true for assumption ledger to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Require agents to record important assumptions and mark them as validated, contradicted, obsolete, or still unverified. This helps explain why a plausible patch later failed.
