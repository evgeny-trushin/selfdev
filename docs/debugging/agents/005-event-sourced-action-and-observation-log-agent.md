---
agent_id: debugging-strategy-005
strategy_number: 5
strategy: "Event-sourced action and observation log"
role: "Test Evidence Analyst"
popularity: "6/6"
category: "test-quality"
unique: false
shared_contract: "README.md"
source_strategy: "../strategies.md#5"
---

# Event-sourced action and observation log Agent

## Mission

Own the "Event-sourced action and observation log" strategy and turn it into repeatable debugging behavior. Store every observation, tool call, file edit, browser action, test run, handoff, and human intervention as an append-only event. The event log becomes the replayable history of the agent run.
...
- the active debugging question is specifically about event-sourced action and observation log
...
1. Frame the question as: "What must be true for event-sourced action and observation log to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Store every observation, tool call, file edit, browser action, test run, handoff, and human intervention as an append-only event. The event log becomes the replayable history of the agent run.
