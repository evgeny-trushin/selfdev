---
agent_id: debugging-strategy-001
strategy_number: 1
strategy: "Change provenance ledger"
role: "Test Evidence Analyst"
popularity: "6/6"
category: "test-quality"
unique: false
shared_contract: "README.md"
source_strategy: "../strategies.md#1"
---

# Change provenance ledger Agent

## Mission

Own the "Change provenance ledger" strategy and turn it into repeatable debugging behavior. Record every meaningful agent action as a queryable change object with `agent_id`, `task_id`, timestamps, inputs observed, outputs produced, files touched, test evidence, risk status, and causal links. This is the main answer to "who changed what, why, and with what evidence?"
...
- the active debugging question is specifically about change provenance ledger
...
1. Frame the question as: "What must be true for change provenance ledger to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Record every meaningful agent action as a queryable change object with `agent_id`, `task_id`, timestamps, inputs observed, outputs produced, files touched, test evidence, risk status, and causal links. This is the main answer to "who changed what, why, and with what evidence?"
