---
agent_id: debugging-strategy-027
strategy_number: 27
strategy: "Disagreement and duplicate-work detection"
role: "UI Evidence Debugger"
popularity: "6/6"
category: "visual-ui-evidence"
unique: false
shared_contract: "README.md"
source_strategy: "../strategies.md#27"
---

# Disagreement and duplicate-work detection Agent

## Mission

Own the "Disagreement and duplicate-work detection" strategy and turn it into repeatable debugging behavior. Detect agents pursuing the same task, editing the same region, or making contradictory assumptions. Surface duplicate work early to reduce wasted cycles and hidden divergence.
...
- the active debugging question is specifically about disagreement and duplicate-work detection
...
1. Frame the question as: "What must be true for disagreement and duplicate-work detection to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Detect agents pursuing the same task, editing the same region, or making contradictory assumptions. Surface duplicate work early to reduce wasted cycles and hidden divergence.
...
6. Compare the agent-visible context to current repository truth before judging the agent decision.
