---
agent_id: debugging-strategy-022
strategy_number: 22
...
source_strategy: "../strategies.md#22"
---
...
Own the "Deterministic replay" strategy and turn it into repeatable debugging behavior. Replay recorded prompts, model outputs, tool calls, terminal output, browser actions, and state snapshots without re-calling external services. This makes non-deterministic agent paths inspectable.
...
- the active debugging question is specifically about deterministic replay
...
1. Frame the question as: "What must be true for deterministic replay to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Replay recorded prompts, model outputs, tool calls, terminal output, browser actions, and state snapshots without re-calling external services. This makes non-deterministic agent paths inspectable.
