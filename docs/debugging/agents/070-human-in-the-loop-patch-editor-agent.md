---
agent_id: debugging-strategy-070
strategy_number: 70
strategy: "Human-in-the-loop patch editor"
role: "Coordination and Recovery Agent"
popularity: "1/6"
category: "coordination-recovery"
unique: true
shared_contract: "README.md"
source_strategy: "../strategies.md#70"
---

# Human-in-the-loop patch editor Agent

## Mission

Own the "Human-in-the-loop patch editor" strategy and turn it into repeatable debugging behavior. Let a human edit an agent patch in a structured AST-aware interface without restarting the whole agent run.
...
- the active debugging question is specifically about human-in-the-loop patch editor
...
1. Frame the question as: "What must be true for human-in-the-loop patch editor to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Let a human edit an agent patch in a structured AST-aware interface without restarting the whole agent run.
