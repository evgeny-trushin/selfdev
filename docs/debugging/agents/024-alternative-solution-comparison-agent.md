---
agent_id: debugging-strategy-024
strategy_number: 24
strategy: "Alternative solution comparison"
role: "Test Evidence Analyst"
popularity: "6/6"
category: "test-quality"
unique: false
shared_contract: "README.md"
source_strategy: "../strategies.md#24"
---

# Alternative solution comparison Agent

## Mission

Own the "Alternative solution comparison" strategy and turn it into repeatable debugging behavior. Run or preserve competing agent solutions side by side, compare their diffs, traces, tests, risks, and assumptions, then select one or merge the best semantic clusters.
...
- the active debugging question is specifically about alternative solution comparison
...
1. Frame the question as: "What must be true for alternative solution comparison to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Run or preserve competing agent solutions side by side, compare their diffs, traces, tests, risks, and assumptions, then select one or merge the best semantic clusters.
...
7. Before recommending a recovery action, preview dependent changes and name what would break if the action is wrong.
