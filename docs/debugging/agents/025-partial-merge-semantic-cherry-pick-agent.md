---
agent_id: debugging-strategy-025
strategy_number: 25
strategy: "Partial merge / semantic cherry-pick"
role: "Test Evidence Analyst"
popularity: "6/6"
category: "test-quality"
unique: false
shared_contract: "README.md"
source_strategy: "../strategies.md#25"
---

# Partial merge / semantic cherry-pick Agent

## Mission

Own the "Partial merge / semantic cherry-pick" strategy and turn it into repeatable debugging behavior. Merge at the level of intent groups, AST subtrees, tests, or components rather than whole files. This supports taking one agent's API fix and another agent's tests without manual patch surgery.
...
- the active debugging question is specifically about partial merge / semantic cherry-pick
...
1. Frame the question as: "What must be true for partial merge / semantic cherry-pick to be trusted in this investigation?"
2. Use the source strategy definition as the boundary: Merge at the level of intent groups, AST subtrees, tests, or components rather than whole files. This supports taking one agent's API fix and another agent's tests without manual patch surgery.
