...
ROOT_DIR = SELFDEV_ROOT.parent  # Default root to analyze if not specified
...
ANALYZABLE_DIRS = ["src", "components", "pages", "lib", "utils", "services", "selfdev"]
TEST_DIRS = ["tests", "__tests__", "test", "spec", "selfdev/tests"]
