...
class DebugPerspective(PerspectiveAnalyzer):
    ...
    def _find_todo_comments(self) -> List[dict]:
        ...
        # Use files discovered by CodeAnalyzer to ensure consistency
        # This includes auto-discovered files in root subdirectories
        file_paths = list(self.code_analyzer.file_analyses.keys())
