...
# Ensure selfdev is in path if running directly
sys.path.insert(0, str(Path(__file__).resolve().parent.parent.parent))

from selfdev.lib.models import (
    Perspective,
    Priority,
    Prompt,
    OrganismState
...
class TestPromptFormatter(unittest.TestCase):
    ...
    def test_format_prompt_file_path_only(self):
        ...
        # Check that line number colon is not present if line_number is None
        # The formatter logic: if prompt.line_number: loc += ...
