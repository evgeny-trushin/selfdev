...
- [E2 — Selection Pressure](../how/E2.md): Only accept changes that improve fitness
- [G4 — Measurable](../how/G4.md): Specific metric thresholds and tests to pass
- [G2 — Actionable](../how/G2.md): Prompts must be immediately actionable
- [M3 — Transparency](../how/M3.md): Expected outcomes are documented
