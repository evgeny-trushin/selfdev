...
- [E3 — Memory](../how/E3.md): Track which prompts led to improvements
- [M3 — Transparency](../how/M3.md): All decisions are logged
- [B4 — Feedback Loops](../how/B4.md): Use historical data for stability and growth signals
- [G1 — Context-Aware](../how/G1.md): State informs prompt generation context
